  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        ...
        className="inline-flex size-10 items-center justify-center rounded-md bg-sky-500 text-white hover:bg-sky-400"
      >
        <MoreHorizontal size={18} />
      </button>

      {open ? (
        <div className="absolute right-0 z-20 mt-2 w-56 rounded-md border border-white/10 bg-slate-950 py-2 shadow-2xl shadow-slate-950/50">
          <Link
